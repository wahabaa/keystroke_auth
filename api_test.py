...
def validate_request_body(keystroke, user='100', sig='814fe8c2123ab9ad26728ebbc71596a0'):
    ...
    :return: data
    '''
    data = {'user': user, 'customer_sig': sig, 'k_data': keystroke}
    return data
...
class Test_api(unittest.TestCase):
    ...
    def test_2_successful_keystroke_auth(self):
        r = requests.post(url=Test_api.VALIDATE_ENDPOINT, json=validate_request_body(Test_api.K_DATA_6))
        self.assertEqual(r.status_code, Test_api.CODE_200)
    ...
    def test_3_failed_keystroke_auth(self):
        r = requests.post(url=Test_api.VALIDATE_ENDPOINT, json=validate_request_body(Test_api.K_DATA_7))
